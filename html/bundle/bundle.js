...
/* harmony export */   "hideActor": () => (/* binding */ hideActor),
/* harmony export */   "showActor": () => (/* binding */ showActor)
/* harmony export */ });
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    for (let i in actores) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contenedor-actores").append(
            `<div class="col-24">
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setHungerLevel": () => (/* binding */ setHungerLevel)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
...
function menosMuslo(num) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(muslos[num]).hide(500)
}
...
function masMuslo(num) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(muslos[num]).show(500)
}
...
/* harmony export */   "getUltimo": () => (/* binding */ getUltimo)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    for (let i in elecciones) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contenedor-secuencias").prepend(
...
/* harmony export */   "audioTrap": () => (/* binding */ audioTrap),
/* harmony export */   "audioMetal": () => (/* binding */ audioMetal),
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    ...
    audioTrap = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#video').get(1);
    audioMetal = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#video').get(2);
    ...
    videoContainer = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#video-container').get(0);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(_videoElements__WEBPACK_IMPORTED_MODULE_1__.video).on('play', () => {
        var icon = _videoElements__WEBPACK_IMPORTED_MODULE_1__.playButton.children();
        _videoElements__WEBPACK_IMPORTED_MODULE_1__.playButton.attr('data-title', 'Pausar (k)');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(_videoElements__WEBPACK_IMPORTED_MODULE_1__.video).on('pause', () => {
        var icon = _videoElements__WEBPACK_IMPORTED_MODULE_1__.playButton.children()
        _videoElements__WEBPACK_IMPORTED_MODULE_1__.playButton.attr('data-title', 'Reproducir (k)')
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mustHideControls": () => (/* binding */ mustHideControls),
/* harmony export */   "waitHideControls": () => (/* binding */ waitHideControls),
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _videoElements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./videoElements */ "./js/videoElements.js");
/* harmony import */ var _videoCards__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./videoCards */ "./js/videoCards.js");
/* harmony import */ var _secuencias__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./secuencias */ "./js/secuencias.js");
 ...
 * @param {number} delay
 */
function waitHideControls(delay) {
    hideControlsEvent = setTimeout(hideControls, delay);
}

function hideControls() {
    if (!(_videoElements__WEBPACK_IMPORTED_MODULE_1__.video.paused || _videoElements__WEBPACK_IMPORTED_MODULE_1__.video.ended) && canHideControls) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(_videoElements__WEBPACK_IMPORTED_MODULE_1__.videoContainer).css('cursor', 'none');
        _videoElements__WEBPACK_IMPORTED_MODULE_1__.videoControls.fadeOut(100);
...
function toggleMute() {
    _videoElements__WEBPACK_IMPORTED_MODULE_1__.video.muted = !_videoElements__WEBPACK_IMPORTED_MODULE_1__.video.muted;
    var icon = _videoElements__WEBPACK_IMPORTED_MODULE_1__.muteToggle.children();
...
function toggleFullScreen() {
    if (document.fullscreenElement) {
        ...
        // @ts-ignore
    } else if (_videoElements__WEBPACK_IMPORTED_MODULE_1__.videoContainer.webkitRequestFullscreen) {
        // Need this to support Safari
        // @ts-ignore
        _videoElements__WEBPACK_IMPORTED_MODULE_1__.videoContainer.webkitRequestFullscreen();
    } else {
        _videoElements__WEBPACK_IMPORTED_MODULE_1__.videoContainer.requestFullscreen();
    }
}

function togglePlay() {
    if (_videoElements__WEBPACK_IMPORTED_MODULE_1__.video.paused || _videoElements__WEBPACK_IMPORTED_MODULE_1__.video.ended) {
...
function rewindScene() {
    var ultimo = _secuencias__WEBPACK_IMPORTED_MODULE_3__.getUltimo();
    if(ultimo != -1){
        _secuencias__WEBPACK_IMPORTED_MODULE_3__.hideSecuencias(ultimo);
    }
}
...
function setVolume(volume) {
    _videoElements__WEBPACK_IMPORTED_MODULE_1__.video.volume = volume;
    _videoElements__WEBPACK_IMPORTED_MODULE_1__.video.muted = false;
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    ...
    _videoElements__WEBPACK_IMPORTED_MODULE_1__.videoControls.on('mouseout', (e) => {
        canHideControls = true;
        hideControlsEvent = setTimeout(hideControls, 1500);
    });

    _videoElements__WEBPACK_IMPORTED_MODULE_1__.rewind.on('click', rewindScene);

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(_videoElements__WEBPACK_IMPORTED_MODULE_1__.videoContainer).on('mousemove', (e) => {
        if (hideControlsEvent)
            clearTimeout(hideControlsEvent);

        jquery__WEBPACK_IMPORTED_MODULE_0___default()(_videoElements__WEBPACK_IMPORTED_MODULE_1__.videoContainer).css('cursor', '');

        _videoElements__WEBPACK_IMPORTED_MODULE_1__.videoControls.fadeIn(100);
        hideControlsEvent = setTimeout(hideControls, 1500);
    });

    _videoElements__WEBPACK_IMPORTED_MODULE_1__.playButton.on('click', togglePlay);

    _videoElements__WEBPACK_IMPORTED_MODULE_1__.playMain.on('click', _videoElements__WEBPACK_IMPORTED_MODULE_1__.video.play);

    _videoElements__WEBPACK_IMPORTED_MODULE_1__.fullscreenToggle.on('click', toggleFullScreen);

    _videoElements__WEBPACK_IMPORTED_MODULE_1__.volumeSlider.on('DOMMouseScroll mousewheel', (e) => {
        e.preventDefault()
        // @ts-ignore
        if (e.originalEvent.detail > 0 || e.originalEvent.wheelDelta < 0) {
            _videoElements__WEBPACK_IMPORTED_MODULE_1__.volumeSlider.val(_videoElements__WEBPACK_IMPORTED_MODULE_1__.volumeSlider.val() <= .1 ? 0 : Number(_videoElements__WEBPACK_IMPORTED_MODULE_1__.volumeSlider.val()) - .1)
        } else {
            _videoElements__WEBPACK_IMPORTED_MODULE_1__.volumeSlider.val(_videoElements__WEBPACK_IMPORTED_MODULE_1__.volumeSlider.val() >= .9 ? 1 : Number(_videoElements__WEBPACK_IMPORTED_MODULE_1__.volumeSlider.val()) + .1);
        }
        setVolume(Number(_videoElements__WEBPACK_IMPORTED_MODULE_1__.volumeSlider.val()))
    })

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(_videoElements__WEBPACK_IMPORTED_MODULE_1__.videoContainer).on('dblclick', toggleFullScreen);

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(_videoElements__WEBPACK_IMPORTED_MODULE_1__.videoContainer).on('click touchend', (e) => {
        if (!_videoCards__WEBPACK_IMPORTED_MODULE_2__.isCardsShown()) {
            if (e.type == 'click') {
                togglePlay()
            }
            else {
                ...
                e.stopPropagation();
                e.preventDefault();
                if (_videoElements__WEBPACK_IMPORTED_MODULE_1__.video.ended || _videoElements__WEBPACK_IMPORTED_MODULE_1__.video.paused) {
                    _videoElements__WEBPACK_IMPORTED_MODULE_1__.video.play();
                }
                else if (_videoElements__WEBPACK_IMPORTED_MODULE_1__.videoControls.css('display') === 'none') {
                    _videoElements__WEBPACK_IMPORTED_MODULE_1__.videoControls.fadeIn(100);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(_videoElements__WEBPACK_IMPORTED_MODULE_1__.video).on('volumechange', volumeChanged)

    _videoElements__WEBPACK_IMPORTED_MODULE_1__.volumeSlider.on('input', () => {
        setVolume(Number(_videoElements__WEBPACK_IMPORTED_MODULE_1__.volumeSlider.val()));
    });
...
function decision(cue, data) {
    ...
    if(data['decision'] >= 0) {
        ...
        _secuencias__WEBPACK_IMPORTED_MODULE_2__.hideSecuencias(data.decision);
    ...
    if (data['levantando']) {
        ...
        _videoCards__WEBPACK_IMPORTED_MODULE_3__.hideCards();
    }
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    ...
    decisionTrack.addEventListener('cuechange', () => {
        for (let i = start; i < decisionCues.length; i++) {
            ...
            if (data['muerte'])
                cue.onexit = _videoElements__WEBPACK_IMPORTED_MODULE_1__.video.pause
            else if (data['comida'])
                cue.onexit = function () {
                    if (status.haComido) {
...
/* harmony import */ var _actores__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./actores */ "./js/actores.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    ...
    __webpack_require__(/*! ./actores */ "./js/actores.js");
    ...
    function desapareceEscena(num) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(str).hide(500)
    }
